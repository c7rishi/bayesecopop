...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(95, 93, "end", "model_mixture_dirichlet_w_allocation");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("v_raw", "(n_groups - 1)", (n_groups - 1));
            num_params_r__ += (1 * (n_groups - 1));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("v_raw", "(n_groups - 1)", (n_groups - 1));
        context__.validate_dims("parameter initialization", "v_raw", "double", context__.to_vec((n_groups - 1)));
        std::vector<double> v_raw((n_groups - 1), double(0));
        size_t v_raw_k_0_max__ = (n_groups - 1);
        for (size_t k_0__ = 0; k_0__ < v_raw_k_0_max__; ++k_0__) {
            v_raw[k_0__] = vals_r__[pos__++];
        }
        size_t v_raw_i_0_max__ = (n_groups - 1);
        for (size_t i_0__ = 0; i_0__ < v_raw_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_lub_unconstrain(0, 1, v_raw[i_0__]);
            } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 18;
            std::vector<local_scalar_t__> v_raw;
            size_t v_raw_d_0_max__ = (n_groups - 1);
            v_raw.reserve(v_raw_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < v_raw_d_0_max__; ++d_0__) {
                if (jacobian__)
                    v_raw.push_back(in__.scalar_lub_constrain(0, 1, lp__));
                else
                    v_raw.push_back(in__.scalar_lub_constrain(0, 1));
            }
            ...
            validate_non_negative_index("pmix_raw", "n_groups", n_groups);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> pmix_raw(n_groups);
            stan::math::initialize(pmix_raw, DUMMY_VAR__);
            stan::math::fill(pmix_raw, DUMMY_VAR__);
            current_statement_begin__ = 24;
            validate_non_negative_index("v", "n_groups", n_groups);
            std::vector<local_scalar_t__> v(n_groups, local_scalar_t__(0));
            stan::math::initialize(v, DUMMY_VAR__);
            stan::math::fill(v, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 26;
            stan::model::assign(v, 
                        stan::model::cons_list(stan::model::index_min_max(1, (n_groups - 1)), stan::model::nil_index_list()), 
                        stan::model::rvalue(v_raw, stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list()), "v_raw"), 
            ...
            stan::model::assign(pmix_raw, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        get_base1(v, 1, "v", 1), 
                        "assigning variable pmix_raw");
            current_statement_begin__ = 31;
            for (int j = 2; j <= n_groups; ++j) {
                current_statement_begin__ = 32;
                stan::model::assign(pmix_raw, 
                            stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                            (((get_base1(v, j, "v", 1) * (1 - get_base1(v, (j - 1), "v", 1))) * get_base1(pmix_raw, (j - 1), "pmix_raw", 1)) / get_base1(v, (j - 1), "v", 1)), 
                            "assigning variable pmix_raw");
            }
            current_statement_begin__ = 34;
            stan::math::assign(pmix, divide(pmix_raw, sum(stan::model::rvalue(pmix_raw, stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list()), "pmix_raw"))));
            ...
            current_statement_begin__ = 23;
            size_t pmix_raw_j_1_max__ = n_groups;
            for (size_t j_1__ = 0; j_1__ < pmix_raw_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(pmix_raw(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: pmix_raw" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable pmix_raw: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 24;
            ...
            for (size_t i_0__ = 0; i_0__ < v_i_0_max__; ++i_0__) {
                ...
                check_less_or_equal(function__, "v[i_0__]", v[i_0__], 1);
            }
            // model body
            {
            ...
            lp_accum__.add(beta_log<propto__>(v_raw, 1, alpha0));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 23;
            validate_non_negative_index("pmix_raw", "n_groups", n_groups);
            Eigen::Matrix<double, Eigen::Dynamic, 1> pmix_raw(n_groups);
            stan::math::initialize(pmix_raw, DUMMY_VAR__);
            stan::math::fill(pmix_raw, DUMMY_VAR__);
            current_statement_begin__ = 24;
            validate_non_negative_index("v", "n_groups", n_groups);
            ...
            if (include_tparams__) {
                ...
                size_t pmix_raw_j_1_max__ = n_groups;
                for (size_t j_1__ = 0; j_1__ < pmix_raw_j_1_max__; ++j_1__) {
                    vars__.push_back(pmix_raw(j_1__));
                }
                size_t v_k_0_max__ = n_groups;
                for (size_t k_0__ = 0; k_0__ < v_k_0_max__; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t k_0__ = 0; k_0__ < v_raw_k_0_max__; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "v_raw" << '.' << k_0__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < pmix_raw_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "pmix_raw" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t v_k_0_max__ = n_groups;
            for (size_t k_0__ = 0; k_0__ < v_k_0_max__; ++k_0__) {
