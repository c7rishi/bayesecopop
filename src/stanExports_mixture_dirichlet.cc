...
#include "stanExports_mixture_dirichlet.h"

RCPP_MODULE(stan_fit4mixture_dirichlet_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mixture_dirichlet")
