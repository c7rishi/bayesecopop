...
namespace model_mixture_dirichlet_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mixture_dirichlet");
    reader.add_event(90, 88, "end", "model_mixture_dirichlet");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mixture_dirichlet : public prob_grad {
private:
        int n_groups;
        int n_data;
        ...
        double alpha0;
public:
    model_mixture_dirichlet(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mixture_dirichlet_namespace::model_mixture_dirichlet";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mixture_dirichlet_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_mixture_dirichlet";
    }
...
typedef model_mixture_dirichlet_namespace::model_mixture_dirichlet stan_model;
#endif
