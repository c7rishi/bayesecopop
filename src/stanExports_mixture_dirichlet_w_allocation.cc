...
#include "stanExports_mixture_dirichlet_w_allocation.h"

RCPP_MODULE(stan_fit4mixture_dirichlet_w_allocation_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mixture_dirichlet_w_allocation")
